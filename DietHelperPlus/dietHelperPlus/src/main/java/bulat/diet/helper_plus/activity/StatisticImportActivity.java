...
import bulat.diet.helper_plus.activity.BaseImportActivity.ImportHistoryCSVTask;
...
public class StatisticImportActivity extends BaseImportActivity {
	public static final String STATISTIC_FILE_PATTERN = "calorie";
	Context ctx = null;
		...
		dialogClickListener = new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				case DialogInterface.BUTTON_POSITIVE:
					try {
						new ImportHistoryCSVTask().execute("");
					} catch (Exception e) {
						e.printStackTrace();
					}
					break;
	...
	protected void onResume() {
		super.onResume();		
		initView(STATISTIC_FILE_PATTERN);		
	}
