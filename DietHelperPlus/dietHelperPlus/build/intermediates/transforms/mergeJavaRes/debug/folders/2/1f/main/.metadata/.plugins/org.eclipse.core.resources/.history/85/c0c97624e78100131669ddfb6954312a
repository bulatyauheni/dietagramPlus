...
public class CaloryAppWidgetProvider56 extends AppWidgetProvider {
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		remoteViews = new RemoteViews(context.getPackageName(), R.layout.widjet56);
		remoteViews.reapply(context, viewToLoad);
		ComponentName thiswidget = new ComponentName(context,
				CaloryAppWidgetProvider56.class);
