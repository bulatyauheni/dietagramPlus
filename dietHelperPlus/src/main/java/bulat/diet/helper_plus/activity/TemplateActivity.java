	...
	private class RecepyUpdateTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
	        ...
	        try {
        	    ...
        	    HttpGet get = new HttpGet("http://old.dietagram.ru/recepy.php?"+"lastid="+SaveUtils.getLastRationId(context)+"&"+"email="+ StringUtils.encrypt(email));
...

		{
...

			{
				...
				Toast.makeText(TemplateActivity.this, "Export successful!", Toast.LENGTH_SHORT)
				 ...
				 SaveUtils.getLastExportedHistoryFileName(TemplateActivity.this);
			}
